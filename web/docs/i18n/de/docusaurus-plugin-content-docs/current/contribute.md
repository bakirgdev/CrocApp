...
sidebar_position: 8
title: Mitwirken
description: Wo Sie die Dokumentation für Mitwirkende und Interna von CrocApp auf GitHub finden.
---

# Mitwirken

Die Dokumentation für Mitwirkende und Interna liegt im Repository, nicht auf dieser Site, weil sie exakt mit dem Code mitgehen muss, während er sich ändert. Diese Site behandelt die Nutzung der App; das Repository behandelt das Bauen und Ändern.

- [`CONTRIBUTING.md`](https://github.com/bakirgdev/CrocApp/blob/main/CONTRIBUTING.md): Einrichtung, Branches, Commits, Stil, Verifikation, PR-Ablauf
- [`CODE_OF_CONDUCT.md`](https://github.com/bakirgdev/CrocApp/blob/main/CODE_OF_CONDUCT.md): Contributor Covenant 3.0
- [`SECURITY.md`](https://github.com/bakirgdev/CrocApp/blob/main/SECURITY.md): Umfang und private Meldung von Sicherheitslücken
