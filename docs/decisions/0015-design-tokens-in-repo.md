...
- Two rules are binding on the app and were carried over from `TODO.md`: **SF Symbols only** and **system font only**. The design system's Lucide glyphs and self-hosted SF Pro OTFs exist solely because a web canvas cannot use Apple system resources.
